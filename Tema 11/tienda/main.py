...
class Cliente:
    ...
    def setApellido(self, nuevoApellido):
        '''
        Cambia el atributo apellido por un nuevo nombre
        '''
...
class Articulo:
    ...
    def setDenominacion(self, nuevaDenominacion):
        '''
        Cambia el atributo denomiancion por una nueva
        '''
        self.__denominacion = nuevaDenominacion
    
    def setPrecio(self, nuevoPecio):
        '''
        Cambia el atributo denomiancion por una nueva
        '''
        self.__precio = nuevoPecio
...
class Factura:
    ...
    def delete(self):
        ...
        sql = 'DELETE FROM linea WHERE numero_factura = ?'
        self.__cursor.execute(sql, (self.__numero,))
        self.__connection.commit()
